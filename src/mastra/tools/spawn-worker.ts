...
export const spawnWorkerTool = createTool({
  id: "spawn-worker",
  description:
    "Spawns a Docker worker container to implement a Linear issue. The worker will clone the repo, create a branch, implement the changes, and POST a callback when done. The branch name is auto-generated.",
